...
export const primeVueConfiguration = {
  ...
  locale: {
    ...
    upload: 'بارگزاری',
    cancel: 'انصراف',
    dayNames: ['یکشنبه', 'دوشنبه', 'سه‌شنبه', 'چهرشنبه', 'پنج‌شنبه', 'جمعه', 'شنبه'],
    dayNamesShort: ['یکشنبه', 'دوشنبه', 'سه‌شنبه', 'چهرشنبه', 'پنج‌شنبه', 'جمعه', 'شنبه'],
    dayNamesMin: ['یکشنبه', 'دوشنبه', 'سه‌شنبه', 'چهرشنبه', 'پنج‌شنبه', 'جمعه', 'شنبه'],
    monthNames: [
      'فروردین',
      'اردیبهشت',
      'خرداد',
